...
fun evaluate(expression: IrExpression, irFile: IrFile, inlineConstTracker: InlineConstTracker?): IrExpression? {
    return expression.accept(ConstInliner(irFile, inlineConstTracker), null)
}
