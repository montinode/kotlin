...
import org.jetbrains.kotlin.wasm.config.wasmUseStackSwitching
...
class BackendWasmSymbols(
    ...
    val coroutinesStackSwitchingIntrinsics =
        if (configuration.wasmUseStackSwitching)
    ...
    inner class CoroutinesStackSwitchingIntrinsics {
        ...
        val nullableContrefIntrinsic by CallableIds.nullableContrefIntrinsic.functionSymbol()
