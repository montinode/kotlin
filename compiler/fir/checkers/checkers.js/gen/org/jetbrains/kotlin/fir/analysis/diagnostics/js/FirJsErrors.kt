...
object FirJsErrors : KtDiagnosticsContainer() {
    ...
    val NON_EXPORTABLE_TYPE_IN_SYNTHETIC_COPY_FUNCTION: KtDiagnosticFactory1<ConeKotlinType> = KtDiagnosticFactory1("NON_EXPORTABLE_TYPE_IN_SYNTHETIC_COPY_FUNCTION", WARNING, SourceElementPositioningStrategies.DECLARATION_SIGNATURE_OR_DEFAULT, KtElement::class, getRendererFactory())
