...
// IGNORE_BACKEND: JVM_IR, NATIVE, WASM_JS, WASM_WASI
...
fun box(): String {
    ...
    if (initOrder != "BAR1 BAR2 IF1 IF2 FOO1 FOO2 ") return "FAIL: initOrder=$initOrder"
    ...
    if (initOrder != "BAR1 BAR2 IF1 IF2 FOO1 FOO2 ") return "FAIL: initOrder after re-access=$initOrder"
