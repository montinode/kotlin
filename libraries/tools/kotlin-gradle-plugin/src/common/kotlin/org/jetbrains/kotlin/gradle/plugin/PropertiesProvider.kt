...
internal class PropertiesProvider private constructor(private val project: Project) {
    ...
    val enableJvmClasspathMetadata: Boolean
        get() = booleanProperty(PropertyNames.KOTLIN_INTERNAL_JVM_CLASSPATH_METADATA) ?: false
    ...
    object PropertyNames {
        ...
        val KOTLIN_INTERNAL_JVM_CLASSPATH_METADATA = property("$KOTLIN_INTERNAL_NAMESPACE.kmp.jvmClasspathMetadata")
