...
class SerializedMetadataLibraryProvider(
    ...
    fragmentsByPackage: Map<String, List<SerializedFragment>>,
    override val metadataVersion: KlibMetadataVersion,
) : KlibModuleMetadata.MetadataLibraryProvider {

    private val fragmentMap: Map<String, MapOfFragmentParts> = fragmentsByPackage.map { [fragmentName, fragmentParts] ->
    ...
    constructor(serializedMetadata: SerializedMetadata) : this(
        ...
        serializedMetadata.fragmentsByPackage,
